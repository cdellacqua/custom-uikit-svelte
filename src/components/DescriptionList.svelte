<script>
	...
	/**
	 * @description Whether the terms of your list should be treated as HTML
	 * @type {boolean} */
	export let termsAreHtml = false;
	/**
	 * @description Whether the details of your list should be treated as HTML
	 * @type {boolean} */
